...
- Le lien du document est proposé dans le panneau d'administration, à côté des feuilles d'émargement, et n'est pas ajouté aux supports proposés à l'apprenant. Le PDF statique ne contient aucune donnée personnelle ou confidentielle ; comme les autres ressources publiques du site, il reste toutefois accessible à une personne qui connaîtrait son adresse directe. Son texte est sélectionnable et extractible, ses 20 pages ont été rendues et contrôlées visuellement, et aucune donnée Supabase ou Qualiopi existante n'a été modifiée.
...
Finaliser un dossier réel (émargements apprenant et formateur verrouillés, puis évaluation finale validée), délivrer l'attestation de réalisation et l'attestation de compétences depuis l'administration, et contrôler leur présence dans « Mes attestations » sur ordinateur et téléphone. La checklist pédagogique de la formation IA générative étant désormais entièrement traitée, appliquer ensuite la même méthode à un seul module modèle de la formation Prompt Engineering - Niveau 1 avant toute généralisation. Les tests complets du paiement, des réservations, du déplacement et de l'émargement restent à réaliser séparément avec plusieurs comptes apprenants.
