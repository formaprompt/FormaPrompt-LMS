...
export const analysisSynthesisCategory: StudioCategoryConfig<AnalysisSynthesisValues> = {
  ...
  fields: [
    {
      ...
      placeholder: 'Exemple : comparer plusieurs retours anonymisés sur l’utilisation d’une nouvelle procédure afin d’identifier les difficultés récurrentes.',
      required: true,
      maxLength: 900,
      rows: 4,
    },
    {
      ...
      options: [
        ...
        { value: 'des réponses à un questionnaire anonymisé', label: 'Questionnaire anonymisé' },
        { value: 'des comptes rendus ou observations anonymisés', label: 'Comptes rendus ou observations' },
    ...
    },
    {
      ...
      placeholder: 'Exemple : cinq retours anonymisés recueillis sur un mois, limités à la phase de validation et sans données individuelles.',
      required: false,
      maxLength: 700,
      rows: 3,
    },
  ...
  messages: {
    ...
    privacy: 'Ne saisissez aucune donnée personnelle, confidentielle, médicale, financière ou sensible. Ne collez aucun rapport, entretien, questionnaire ou jeu de données réel ; décrivez uniquement des sources génériques, fictives ou anonymisées.',
  ...
  examples: [
    ...
    {
      title: 'Analyse de retours anonymisés',
      description: 'Regrouper des difficultés par thème sans généraliser au-delà des données.',
      prompt: 'Analyse des retours anonymisés par thème, fréquence et impact. Signale les cas isolés et ne déduis aucune cause qui ne figure pas dans les sources.',
    },
    {
