...
const percentPromotion = {
  id: 'promo-1', code: 'PROMO10', description: 'Campagne diagnostic', discount_type: 'percent',
  ...
  minimum_final_amount_cents: 0, targets: [{ target_type: 'diagnostic', target_key: 'diagnostic-ia-express' }],
...
describe('AdminPromotions', () => {
  ...
  it('affiche le chargement, la liste, les remises et les utilisations', async () => {
    ...
    expect(row).toHaveTextContent('diagnostic / diagnostic-ia-express');
