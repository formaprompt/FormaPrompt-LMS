  ...
  return (
    <>
      ...
      <div className="card mb-4">
        ...
        <p className="mb-2"><strong>Finalités du traitement :</strong> Les données collectées (nom, email, etc.) sont utilisées dans le cadre de la gestion des demandes de contact, de l'inscription aux formations, et de la facturation des ventes en ligne via nos partenaires de paiement (Stripe, PayPal).</p>
        <p className="mb-2"><strong>Base juridique :</strong> Le traitement est basé sur le consentement de l'utilisateur ou l'exécution d'un contrat (inscription/achat).</p>
        ...
        <p className="mb-2"><strong>Destinataires des données :</strong> Les données sont strictement réservées à l'usage de Thierry FREZARD EI et ne sont en aucun cas vendues à des tiers.</p>
        <p className="mb-2"><strong>Durée de conservation :</strong> Les données sont conservées pendant la durée nécessaire à la finalité de leur traitement, dans le respect des obligations légales et réglementaires (par exemple, 10 ans pour les pièces comptables).</p>
