...
BEGIN;
SET LOCAL ROLE service_role;
SELECT id AS cgv_id FROM public.legal_document_versions WHERE version='CGV-B2C-2026-08-12' LIMIT 1 \gset
...
echo "Phase Express promotion concurrency validation: PASS"
