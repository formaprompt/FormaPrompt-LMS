-- Ajoute le rythme distant 4 h + 4 h + 2 h à la formation IA générative.
-- Les réservations et émargements existants restent inchangés.
...
BEGIN
  ...
  v_format_valid := CASE v_booking.schedule_format
    ...
    WHEN 'three_4h_4h_2h' THEN
      (v_prior_minutes IN (0, 240) AND v_selected_minutes = 240)
      OR (v_prior_minutes = 480 AND v_selected_minutes = 120)
